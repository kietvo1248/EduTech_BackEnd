...
export abstract class UserSubscriptionRepositoryAbstract {
  ...
  abstract create(data: Omit<UserSubscription, 'id' | 'createdAt' | 'updatedAt'>): Promise<UserSubscription>;
  abstract update(id: string, data: Partial<UserSubscription>): Promise<UserSubscription | null>;
  abstract delete(id: string): Promise<void>;
  abstract findByUserId(userId: string): Promise<UserSubscription[]>;
  abstract findActiveSubscription(userId: string): Promise<UserSubscription | null>;
  abstract findByUserAndStatus(userId: string, status: string): Promise<UserSubscription[]>;
