...
export abstract class ChapterRepositoryAbstract {
  ...
  abstract create(data: Omit<Chapter, 'id' | 'createdAt' | 'updatedAt'>): Promise<Chapter>;
  ...
  abstract reorderChapters(courseId: string, chapters: Array<{ id: string; orderIndex: number }>): Promise<Chapter[]>;
}
