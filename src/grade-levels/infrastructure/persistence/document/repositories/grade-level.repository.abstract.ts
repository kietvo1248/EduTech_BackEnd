...
export abstract class GradeLevelRepositoryAbstract {
  ...
  abstract create(data: Omit<GradeLevel, 'id' | 'createdAt' | 'updatedAt'>): Promise<GradeLevel>;
  abstract update(id: string, data: Partial<GradeLevel>): Promise<GradeLevel | null>;
